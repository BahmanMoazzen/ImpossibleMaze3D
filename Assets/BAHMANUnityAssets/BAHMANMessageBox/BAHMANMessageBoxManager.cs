...
public class BAHMANMessageBoxManager : MonoBehaviour
{
    ...
    {
        _YesNoBoxMessageText.text = iMessage;
        _YesNoBoxTitleText.text = iTitle;
        _YesNoBoxYesButton.onClick.RemoveAllListeners();
        _YesNoBoxYesButton.onClick.AddListener(iYesAction);
        _YesNoBoxYesButton.onClick.AddListener(_closeYesNoBox);
        _YesNoBoxPanel.SetActive(true);
    ...
    [Header("Yes No Box Setting")]
    [SerializeField] GameObject _YesNoBoxPanel;
    [SerializeField] Text _YesNoBoxTitleText;
    [SerializeField] Text _YesNoBoxMessageText;
    [SerializeField] Button _YesNoBoxYesButton;
    ...
    void _closeYesNoBox()
    {
        _YesNoBoxPanel?.SetActive(false);
    }
